...
$rss = Feed::loadRss('paste-your-feed-here-and-dont-delete-the-apostrophes');

foreach($rss->item as $element){
	if(!file_exists('paste-your-torrent-collection-folder-here-with-correct-slashes'.$element->title.'.torrent') AND !file_exists('paste-your-downloading-folder-here'.$element->title) AND !file_exists('place-your-downloaded-folder-here'.$element->title)){
		download_file($element->link,'paste-your-torrent-collection-folder-here-with-correct-slashes'.$element->title.'.torrent');
	}
}
